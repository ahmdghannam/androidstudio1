...
//            observable.subscribe(observer);
            Observable.just(1,2,3,4,5)
                    .doOnNext(c->Log.d(TAG,"upStream"+c+"\tthread :"+Thread.currentThread().getName())).subscribeOn(Schedulers.computation())
                    .subscribe(o->Log.d(TAG,"dnStream"+o+"\tthread :"+Thread.currentThread().getName()));
